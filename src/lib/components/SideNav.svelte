      ...
      <ul role="list">
        ...
        <li class="sideNavOption navUnderline">
            ...
            <a href="#" class='specialLink'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="specialSVG lg:h-6 lg:w-6 ">
        ...
        <li class='sideNavOption'>
            <a href="#" class='specialLink responsiveText'><span class="hideOnMobile">Log out</span> 
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="specialSVG">
